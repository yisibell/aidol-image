(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["aidol-image"] = factory(require("vue"));
	else
		root["aidol-image"] = factory(root["Vue"]);
...
// CONCATENATED MODULE: ./src/pkg/main.vue?vue&type=template&id=59477678&
...
/* harmony default export */ var mainvue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    switchHandler: function switchHandler(index) {
      var _this2 = this;

      this.$nextTick(function () {
        var el_image_viewer = _this2.$refs['el-image-viewer'];

        _this2.$emit('switch', index, el_image_viewer);

        _this2.createViewerTips(index, el_image_viewer);
      });
    },
    // create image viewer tips
    createViewerTips: function createViewerTips(index, viewer) {
      var tips = this.viewerTips;
      var str = '';
      ...
      if (str) {
        ...
        var className = this.viewerTipsClassName;
        var id = "".concat(this.viewerTipsClassName, "-").concat(this._uid);
        var isExitDiv = document.querySelector("#".concat(id));
        div.innerHTML = str;
